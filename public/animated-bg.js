...
(function () {
  ...
  const COUNT = prefersReduced ? 0 : isMobile ? 25 : 70;
  let particles = [];
  let W, H;
  ...
  /* ─────────────────────────────────────────────
     Button glow mouse tracking
  ───────────────────────────────────────────── */
  document.addEventListener('mousemove', e => {
    document.querySelectorAll('.btn-primary,.btn-cta,.news-read-more').forEach(btn => {
  ...
  console.log('%c✦ TVK AnimatedBG v1.0', 'color:#FECE08;font-weight:bold;font-size:14px;');
})();
